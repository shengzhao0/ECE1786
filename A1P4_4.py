...
if __name__ == "__main__":
    ...
    X, T, Y = tokenize_and_preprocess_text(txt, w2i, 3)
   # convert the first 20 tokens back to words
    print("First 20 tokens: ", [i2w[i] for i in X[:40]])
    print("First 20 context tokens: ", [i2w[i] for i in T[:40]])
    print ("First 20 labels: ", Y[:40])
